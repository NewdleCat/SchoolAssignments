...
There are packages available for people in order to help create graphs such as \texttt{pgfplots}. In this case I simply input the numbers into Google Sheets and took a screenshot, I then used the same code from above to put it in as an image.
\begin{figure}[]
...
have not done this section just yet
